 ...
 * Plugin URI: https://wordpress.org/plugins/vindi-woocommerce-subscriptions/
...
if (!class_exists('Vindi_WooCommerce_Subscriptions')) {
    class Vindi_WooCommerce_Subscriptions
    {
        ...
        /**
         * Update user information from My Account form
         */
        ...
        {
            if (!$this->is_product_type_from_post(['subscription', 'variable-subscription'])) {
                return;
            }
        ...
        {
            if (!$this->is_product_type_from_post(['variable-subscription'])) {
                return;
            }
        ...
        public function user_related_orders_actions($actions, $order)
        {
            ...
            return $this->filter_actions($actions, array(
                'pay',
                'cancel',
                //'view',
            ));
        ...
        private function filter_actions($actions, $filter)
        {
            ...
            $filtered_actions_keys = array_diff(array_keys($actions), $filter);

            foreach ($filtered_actions_keys as $key) {
                $filtered_actions[$key] = $actions[$key];
            }
        ...
        public function add_support_to_tlsv1_2($ch)
        {
            ...
            if ('app.vindi.com.br' !== $host_to || !defined('CURL_SSLVERSION_TLSv1_2')) {
                return;
            }
